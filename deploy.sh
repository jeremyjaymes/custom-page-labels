...
# See http://thereforei.am/2011/04/21/git-to-svn-automated-wordpress-plugin-deployment/ for info.
...
CURRENTDIR=`pwd`
MAINFILE="custom-page-labels.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="jeremyjaymes" # your svn username
